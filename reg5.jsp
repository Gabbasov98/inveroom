<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    ...
    <%
    String pass_status = (String) session.getAttribute("pass_status");
...
%>
        ...
        <body>
            <div class="server-data">
                <span class="server-phone"><%= email %></span>
                <span class="server-status"><%= pass_status %></span>
            </div>
            ...
            <div class="wrapper">
                ...
                <div class="auth">
                    <div class="auth__wrap">
                        ...
                        <div class="auth__desc">На почту
                            <a id="inputedEmail">
                                <%= email %>
                            </a> был отправлен ваш временный пароль
                        </div>
                        <form action="" class="auth__form" id="regForm5">
                            <fieldset class='auth__form-group form-group2'>
                                <input type='password' name="pass" />
                                <label>Введите пароль из E-mail</label>
                                <div class="form-group2__error-text">
                                    <span class="codeEmpty">Введите пароль</span>
                                    <span class="codeIncorrect">неверный пароль</span>
                                </div>
                            </fieldset>
                            ...
                            <div class="auth__nav">
                                <a href="reg4.jsp" class="auth__back btn btn-blue-light">
                                ...
                                <button formaction="index?action=reg_step_5" formmethod="POST" type="submit" class="auth__btn btn btn-blue">Далее</button>
                            </div>
                        </form>
                        <form class="sendagain">
                            <button id="sendNewCode" formaction="index?action=send_email_again" formmethod="POST" type="submit" class="auth__btn btn btn-blue">test</button>
                        </form>
                    </div>
                </div>
            ...
            <script>
                ...
                if (emailStatus === "false") {
                    seconds = sessionStorage.getItem('sendEmailAgainSeconds') || 60;
                    $(pass).parents(".form-group2").addClass("form-group2--error")
                ...
                function validate() {
                    if (!$(pass).val()) {
                        ...
                        $(pass).parents(".form-group2").removeClass("form-group2--error")
                    }
                ...
                $(".auth__disabled-btn").click(function() {
                    if (validate()) {
                        sessionStorage.setItem('sendEmailAgainSeconds', seconds.toString())
                        $("#regForm5 button[type='submit']").click()
                    }
                });
