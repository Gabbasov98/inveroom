<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    <%
        ...
        String status = (String) session.getAttribute("phone_exist_status");
        if(phone == null){phone="";}
    ...
    %>
        ...
        <body>
            ...
            <div class="wrapper">
                ...
                <div class="auth">
                    <div class="auth__wrap">
                        <div class="auth__title">Укажите свой телефон</div>
                        ...
                        <form action="" class="auth__form" id="regForm2">
                            <fieldset class='auth__form-group form-group2'>
                                ...
                                <div class="form-group2__error-text">
                                    <span class="codeEmpty">Введите телефон</span>
                            ...
                            <div class="auth__nav">
                                <a href="reg.html" class="auth__back btn btn-blue-light">
                                ...
                                <button formaction="index?action=reg_step_2" formmethod="POST" type="submit" class="auth__btn btn btn-blue">Далее</button>
            ...
            <script>
                let localPhone = sessionStorage.getItem('phone');
                if (localPhone !== 'undefined') {
                    $("input[name='phone']").val(localPhone)
                }
                let phoneStatus = $(".server-status").html()
                let serverPhone = $(".server-phone ").html()
                ...
                if (serverPhone) {
                    if (phoneStatus === "false") {
                        console.log(true)
                        $(phone).parents(".form-group2").addClass("form-group2--error")
                ...
                function validate() {
                    ...
                    if ($(phone).val().length < 2) {
                        ...
                        $(phone).parents(".form-group2").removeClass("form-group2--error")
                    }
